...
function setup_aliases(){
  ...
  alias t='tmux -u'
  alias kc='kubectl'
  alias wkc='tmux split-window -h "kubectl get pods -w"; tmux split-window -v "kubectl get prowjobs -w"; tmux split-window -v "kubectl get pipelinerun -w"; watch jx logs -k'
}
